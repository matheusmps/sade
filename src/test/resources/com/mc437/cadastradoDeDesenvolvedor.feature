Feature: Cadastrar um novo desenvolvedor
    ...
    Scenario: Cadastro de um novo desenvolvedor válido.
        When Entro na página 'http://sample-env-2.v5vayj2nke.us-west-2.elasticbeanstalk.com/register.html'
    ...
    Scenario Outline: Cadastro de um desenvolvedor com entrada inválida
        ...
        Then sou redirecionado para a página "http://sample-env-2.v5vayj2nke.us-west-2.elasticbeanstalk.com/register.html"
