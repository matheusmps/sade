...
import com.mc437.configuration.MySimpleUrlAuthenticationSuccessHandler;
...
//				.tokenValiditySeconds(86400).and().csrf().and().exceptionHandling().accessDeniedPage("/Access_Denied");
	...
	@Bean
	public MySimpleUrlAuthenticationSuccessHandler successAuthHandler(){
